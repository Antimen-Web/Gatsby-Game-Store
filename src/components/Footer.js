        ...
        <div className={styles.content}>
          <div className={styles.middle}>
            <Link className={styles.logo} to="/">
              ...
              />
              <span className={styles.logo_title}>GameStore</span>
            </Link>
            <ContactForm />
          </div>
        </div>
        <div className={styles.bottom}>
          ...
          <div className={styles.menu}>
            <ul className={styles.menu_list}>
              <li>
                <Link className={styles.item} to="/terms-of-service">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link className={styles.item} to="/privacy-policy">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link className={styles.item} to="/refund-policy">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link className={styles.item} to="/shipping-policy">
                  Shipping Policy
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link className={styles.item} to="/contact-us">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link className={styles.item} to="/payment-policy">
                  Payment Policy
                </Link>
              </li>
            </ul>
