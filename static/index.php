...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 5863;
        $headers['auth']['clientCompany'] = "gYhkW8YqUF1bX4TYrt19";
        $headers['auth']['clientSecret'] = "NTg2M2dZaGtXOFlxVUYxYlg0VFlydDE5Y2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
